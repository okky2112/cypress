describe('Scenario Batalkan Undangan Karyawan', () => {
    it.only('Batalkan Undangan Karyawan Berhasil', () => {
        ...
        //Klik opsi "Batalkan Undangan"
        cy.get('.css-1xkex5x > :nth-child(2)').click()
        //Klik Button "Batalkan Undangan"
        cy.get('.css-1q5wn6b').click()
        //Memverifikasi bahwa Batalkan undangan karyawan berhasil
