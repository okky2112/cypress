describe('Scenario Aktifkan Status Karyawan', () => { 
    it.only('Aktifkan Status Karyawan Berhasil', () => {
        ...
        //Klik button "Aktifkan"
        cy.get('[data-testid="btn-submit-general"]').click()
        //Memverifikasi bahwa "Aktifkan Status Karyawan Berhasil"
